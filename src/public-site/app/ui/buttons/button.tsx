...
const variantStyles: VariantSeverityStyle = {
	primary: {
		text: " text-primary hover:bg-primary hover:text-white focus:ring-1 focus:ring-primary",
	...
	secondary: {
		text: " hover:bg-gray-100 hover:text-black focus:ring-1 focus:ring-gray-400",
...
export const PButton: React.FC<ButtonProps> = ({
	...
	return (
		<button
			className={`flex items-center justify-center px-4 py-2 rounded-md font-medium transition-colors duration-200 focus:outline-none cursor-pointer ${style} ${props.className || ""}`}
			{...props}
		>
			{children}
		</button>
